      ...
      <section className="xl:mt-[150px] lg:mt-[115px] md:mt-[85px] sm:mt-[70px] mt-14">
        <div className="my_container">
          ...
          <div className="flex flex-col items-center justify-center mt-5 sm:mt-7">
            ...
            <div className="w-full sm:w-5/6 md:w-[70%] mx-auto flex flex-col sm:flex-row gap-4 sm:gap-6 md:gap-8 mt-6 sm:mt-9 md:mt-12 lg:mt-15 xl:mt-[75px] px-4 sm:px-0">
              <input
                type="email"
